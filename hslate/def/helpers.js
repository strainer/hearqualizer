...
function slinkgfup(c){ //sine like transition through unit interval ,/'
  return c*(1+c)*4 
}
function slinkfgdn(c){ //sine like transition through unit interval ,/'
  return c*(1-c)*4 
}


function lerp(c, d, u ) { return  c+(d-c)*u } //c slides to d on u
function slerp(c, d, u ) { return  c+(d-c)*slinku(u) } //smoothed lerp
